...
public class EventHandler {
	...
	public void checkEvent() {//event Happens
		...
		//if(hit(23,15,"any") == true) {damagePit(21,8,gp.dialogueState);}
			for(int i = 21; i < 26; i++ ) {
				if(hit(0,i,13,"up") == true) {healingPool(gp.dialogueState);}
			}
			if(hit(0,20,8,"left") == true) {teleport(gp.dialogueState);}
			else if(hit(0,10,40,"any") == true ) {teleport(1,12,13);}
